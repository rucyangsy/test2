...
class RolloutStorage(object):
    def __init__(self, num_steps, num_processes, obs_shape, action_space,
                 ...
                 keep_buffer=False, buffer_size=60):     #5, 16， 
        ...
        self.use_gt_objects_loc = use_gt_objects_loc   #待看 默认false
    ...
    def after_update(self):    #将最后一个step的值作为下一个循环的初始值
    ...
    def compute_returns(self,                #待看
                        next_value,
                        use_gae,
                        gamma,
                        gae_lambda,
                        use_proper_time_limits=True):   #use_gae = false, 0.99, 0.95, false
    ...
    def feed_forward_generator(self,
        ...
        batch_size = num_processes * num_steps   #16*5
